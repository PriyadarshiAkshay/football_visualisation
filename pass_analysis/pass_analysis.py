...
ax.legend([goal_legend, accurate_legend, missed_legend], ['Goal', 'Accurate', 'Missed'], loc='upper right',bbox_to_anchor=(.97, .96))
...
#plt.show()
plt.savefig("figures/"+f"{team_name}_{fname}_passes_{opponent_name}.jpg")
plt.close()
############################################
############################################
#############################################
