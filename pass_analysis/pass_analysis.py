...
def load_and_analyse_data(team_name,opponent_name=None,offensive_passes=True,include_passes=True):
    # Load the data
    ...
    team_wyId = get_team_wyId(df_teams,team_name)
    ...
    selected_match=int(filtered_matches['wyId'].iloc[0])

    #Select the events of the selected match
    team_matches_events = world_cup_events[world_cup_events.matchId.isin([selected_match])]
    ...
    team_matches_events = team_matches_events.drop(columns=['tags'])

    team1_players_names = team1_players.loc[:, ['playerId', 'lastName', 'firstName']].drop_duplicates(subset=['playerId', 'lastName','firstName'])

    return team_matches_events, team_wyId, selected_match, team1_players_names, team1_players, opponent_name

##### common stuff ####

def plot_shots(team_matches_events, team_wyId, selected_match, team1_players_names, team_name, opponent_name):
...
def plot_passes(team_matches_events, team_wyId, selected_match, team1_players_names, team_name, opponent_name, offensive_passes):
...
def plot_pass_network(team_matches_events, team_wyId, selected_match, team1_players, team_name, offensive_passes, include_passes):
...
def centralisation_index(df_pass):
...
def passing_scatterplot(team_matches_events, team_wyId, team1_players_names):
    df_team1_matches_events = team_matches_events[(team_matches_events.eventName=='Pass') & (team_matches_events.teamId == team_wyId)].rename(columns={'label': 'matchName'})
    df_team1_matches_events = pd.merge(df_team1_matches_events, team1_players_names, on='playerId')
...
def plot_passes_gif(team_matches_events, team_wyId, selected_match, team1_players_names, team_name, opponent_name, offensive_passes):
    df_team1_matches_events = team_matches_events[(team_matches_events.eventName=='Pass') & (team_matches_events.teamId == team_wyId)].rename(columns={'label': 'matchName'})
    df_team1_matches_events = pd.merge(df_team1_matches_events, team1_players_names, on='playerId')
...
team_matches_events, team_wyId, selected_match, team1_players_names, team1_players, opponent_name = load_and_analyse_data(team_name,opponent_name,offensive_passes,include_passes)

plot_shots(team_matches_events, team_wyId, selected_match, team1_players_names, team_name, opponent_name)

plot_passes(team_matches_events, team_wyId, selected_match, team1_players_names, team_name, opponent_name, offensive_passes)

df_pass=plot_pass_network(team_matches_events, team_wyId, selected_match, team1_players, team_name, offensive_passes, include_passes)

centralisation_index(df_pass)

passing_scatterplot(team_matches_events, team_wyId, team1_players_names)

# Usage
plot_passes_gif(team_matches_events, team_wyId, selected_match, team1_players_names, team_name, opponent_name, offensive_passes)
